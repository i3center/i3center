    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card shadow rounded-lg border-0 pt-2">
                ...
                <div class="card-body">
                    <form method="post" action="{{ URL::asset("/admin/menu") }}/{{ isset($menu) ? 'edit' : 'add' }}"
                          id="form">
                        <div class="row">
                            <div class="col-12">
                                <div class="form-row">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <select class="form-control" name="parent_id">
                                            <option value="0" {{Request::old('parent_id') && Request::old('parent_id') == '0' ? 'selected' : (isset($menu) && $menu->parent_id == '0' ? 'selected' : '') }}>
                                                منوی اصلی
                                            </option>
                                            @foreach($parent_menus as $parent_menu)
                                                <option value="{{$parent_menu->id}}" {{Request::old('parent_id') && Request::old('parent_id') == $parent_menu->id ? 'selected' : (isset($menu) && $menu->parent_id == $parent_menu->id ? 'selected' : '') }}>
                                                    {{$parent_menu->title}}
                                                </option>
                                            @endforeach
                                        </select>
