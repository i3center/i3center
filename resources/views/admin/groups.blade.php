...
@section('content')
    ...
    <div class="row">
        <div class="col-6">
            <div class="card shadow rounded-lg border-0 pt-2">
                ...
                <div class="card-body">
                    @if(count($groups) == 0)
                        <h5 class="card-title">گروه وجود ندارد</h5>
                    @else
                ...
                <div class="card-footer text-muted">
                    برای افزودن گروه جدید <i class="fas fa-plus-square"></i> را بزنید
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="modal-dialog modal-sm" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h6 class="modal-title">افزودن گروه</h6>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <form method="post" action="{{ URL::asset("/admin/group/add") }}" id="addForm">
    ...
    <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog modal-sm" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h6 class="modal-title">ویرایش گروه</h6>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <form method="post" action="{{ URL::asset("/admin/group/edit") }}" id="editForm">
                        <div class="form-group">
    ...
    <script>
        ...
        $('#deleteModal').on('show.bs.modal', function (event) {
            ...
            btn_delete.attr("href", '{{ URL::asset("/admin/group/delete") }}' + '/' + id);
        })
    </script>
@endsection